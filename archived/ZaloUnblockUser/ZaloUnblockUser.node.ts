...
export class ZaloUnblockUser implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Zalo Bỏ Chặn Người Dùng',
		name: 'zaloUnblockUser',
		group: ['Zalo'],
		version: 1,
		description: 'Bỏ chặn một người dùng trên Zalo',
		defaults: {
			name: 'Zalo Bỏ Chặn Người Dùng',
		},
